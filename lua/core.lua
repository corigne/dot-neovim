...
-- Formatters for each filetype (used by autocmd module)
vim.g.autoformat_filetypes = {
	go = true,
	lua = true,
	python = true,
	rust = true,
...
-- default formatter is to run formatter for the attached
vim.g.formatters = {
	-- add alternative format delegates here
}
